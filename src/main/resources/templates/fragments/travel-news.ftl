            ...
            <div class="item">
                <div class="row">
                    <div class="col-sm-6 main-post-inner bord-right">
                        <article>
                            <figure>
                                <a href=""><img src="/static/assets/images/340x215-3.jpg" height="242" width="345" alt="" class="img-responsive"></a>
                            ...
                            <div class="row row-margin">
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-1.jpg" class="img-responsive" alt="">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-2.jpg" class="img-responsive" alt="">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-3.jpg" class="img-responsive" alt="">
                                                <div class="link-icon"><i class="fa fa-camera"></i></div>
                                            </a>
                                        </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-4.jpg" class="img-responsive" alt="">
                                                <div class="link-icon"><i class="fa fa-play"></i></div>
                                            </a>
                                        </div>
            ...
            <div class="item">
                <div class="row">
                    <div class="col-sm-6 main-post-inner bord-right">
                        <article>
                            <figure>
                                <a href=""><img src="/static/assets/images/340x215-4.jpg" height="242" width="345" alt="" class="img-responsive"></a>
                                <span class="post-category">Travel</span>
                            </figure>
                            <div class="post-info">
                                <h3><a href="#">Fusce ac orci sagittis mattis magna ultrices libero</a></h3>
                            ...
                            <div class="row row-margin">
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-5.jpg" class="img-responsive" alt="">
                                                <div class="link-icon"><i class="fa fa-camera"></i></div>
                                            </a>
                                        </div>
                                        <h5><a href="#" class="title">Lorem Ipsum is simply dummy text of the printing.</a></h5>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-6.jpg" class="img-responsive" alt="">
                                                <div class="link-icon"><i class="fa fa-camera"></i></div>
                                            </a>
                                        </div>
                                        <h5><a href="#" class="title">It is a long established fact that a reader will be distracted by</a></h5>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-7.jpg" class="img-responsive" alt="">
                                                <div class="link-icon"><i class="fa fa-camera"></i></div>
                                            </a>
                                        </div>
                                        <h5><a href="#" class="title">There are many variations of passages of Lorem Ipsum.</a></h5>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-padding">
                                    <div class="grid-item">
                                        <div class="grid-item-img">
                                            <a href="#">
                                                <img src="/static/assets/images/165x110-8.jpg" class="img-responsive" alt="">
                                                <div class="link-icon"><i class="fa fa-camera"></i></div>
                                            </a>
                                        </div>
                                        <h5><a href="#" class="title">Contrary to popular belief, Lorem Ipsum is not simply random text.</a></h5>
